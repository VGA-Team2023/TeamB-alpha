        ...
        public class PrologueFix : MonoBehaviour
        {
            public void Start()
            {
                var commands = CommandLoader.LoadSheet(
                    ...
                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_2,1.0]
                    [ChangeCaption,ナレーション]
                    [PrintText,その魔石は不思議な力でエネルギーを生み出し、人々の生活を豊かにしたのであった。,0.1]
                    [EndGroup]

                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_3,1.0]
                    [ChangeCaption,ナレーション]
                    [PrintText,やがて文明は発達し、次々と新たな発明が生まれていった。,0.1]
                    [EndGroup]

                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_4,1.0]
                    [ChangeCaption,ナレーション]
                ...
                　　[ChangeCaption,ナレーション]
                    ...
                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_6,1.0]
                　　[ChangeCaption,ナレーション]
                    [PrintText,マルム・ラピスを恐れる者たちが多く現れるなか、魔獣に対抗するため、それをを研究する者たちも現れた。,0.1]
                    [EndGroup]

                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_7,1.0]
                　　[ChangeCaption,ナレーション]
                    [PrintText,そしてその内の一人はマルム・ラピスを採取し、加工をすることで浄化された魔石ラピスを錬成する。,0.1]
                    [EndGroup]

                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_8,1.0]
                　　[ChangeCaption,ナレーション]
                ...
                　　[ChangeCaption,ナレーション]
                    ...
                    [BeginGroup]
                    [SoundVoice,narration,VOICE13_narration_10,1.0]
                　　[ChangeCaption,ナレーション]
