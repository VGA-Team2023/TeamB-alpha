...
namespace TeamB_TD
{
    ...
    {
        public class Fix_Ending4 : EndingBase
        {
            public void Start()
            {
...
　　　　　　　　　　 [ChangeCaption,ルナ]
                    ...
                    [ChangeCaption,ルナ]
                    [PrintText,（ここは地球と似ているけれど、魔獣の姿やグラウスさんたちの術はどう考えても地球ではあり得ないし…。）,0.1]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_2,1.0]
　　　　　　　　　　[DisplayActor,4,1]
                    [ChangeCaption,グラウス]
                    [PrintText,「聞いてんのか？」,0.1]
                    [EndGroup]
                    ...
                    [ChangeCaption,ルナ]
                    [PrintText,呼ばれた方を見るとグラウスがいた。,0.1]

                    [ChangeCaption,ルナ]
                    [PrintText,「ごめんなさい、グラウスさん。呼ばれてたの気が付かなくて。」,0.1]

                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_3,1.0]
                    [ChangeCaption,グラウス]
                    [PrintText,「いや…、あんまり離れるな。またいつ魔獣が現れるかわかんねぇからな。」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_4,1.0]
                    [ChangeCaption,グラウス]
                    [PrintText,「悩み事か？」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_5,1.0]
　　　　　　　　　　 [ChangeCaption,グラウス]
                    [PrintText,「あんたには戦いで世話になってる。俺で良いなら聞いてやる。」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_6,1.0]
                    [ChangeCaption,グラウス]
                    [PrintText,「借りっぱなしは性に合わねぇんだ。」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_7,1.0]
                    [ChangeCaption,グラウス]
                    [PrintText,「…まぁいい。聞いたところで気の利いた言葉も浮かばねぇからな立場上、俺にできることも限られてる。だが…。」,0.1]
                    [EndGroup]

                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_8,1.0]
                    [ChangeCaption,グラウス]
                    [PrintText,「お前がここにいる限りは何があっても守る。それだけは約束しておく。戻る場所があるなら、記憶が戻るまではここにいればいい。」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit4,VOICE12_ending4_9,1.0]
                    [ChangeCaption,グラウス]
                    [PrintText,「…また街がにぎやかになりそうだな。」,0.1]
                    [EndGroup]

　　　　　　　　　　[ChangeCaption,ルナ]
                    [PrintText,そう言うとグラウスは私の手を引いて、街の中へと連れていく。,0.1]

                    [ChangeCaption,ルナ]
                    [PrintText,（しばらくは元の世界に戻れないかもしれないけれど、それでも、彼らと…グラウスさんと一緒にいられたらとても心強いな…。）,0.1]
                    [ChangeCaption,]
                    [PrintText,＿＿ギギギ…,0.1]
