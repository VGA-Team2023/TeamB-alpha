...
namespace TeamB_TD
{
    ...
    {
        public class Fix_Ending6 : EndingBase
        {
            public void Start()
            {
                var commands = CommandLoader.LoadSheet(
                    ...
                    [ChangeCaption,ルナ]
                    [PrintText,（ここは地球と似ているけれど、魔獣の姿やケヴィンたちの術はどう考えても地球ではあり得ないし…。）,0.1]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_1,1.0]
                    [ChangeCaption,ケヴィン]
                    [PrintText,「おーーい。」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_2,1.0]
　　　　　　　　　　[DisplayActor,6,1]
                    [ChangeCaption,ケヴィン]
                    [PrintText,「きいてる？」,0.1]
                    [EndGroup]
                    ...
                    [ChangeCaption,ルナ]
                    [PrintText,呼ばれた方を見るとケヴィンがいた。,0.1]

                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_3,1.0]
　　　　　　　　　　[ChangeCaption,ケヴィン]
　　　　　　　　　　[PrintText,「うわ、びっくりした。脅かさないでよ。」,0.1]
                    [EndGroup]

                    [ChangeCaption,ルナ]
                    [PrintText,「ケヴィン、ごめん。呼ばれてたの気が付かなくて。」,0.1]
...
　　　　　　　　　　[ChangeCaption,ルナ]
                    [PrintText,「ごめんなさい、ちょっとだけ外に出たくなっちゃって…。」,0.1]

                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_4,1.0]
                    [ChangeCaption,ケヴィン]
                    [PrintText,「で？」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_5,1.0]
　　　　　　　 　　 [ChangeCaption,ケヴィン]
                    [PrintText,「いや、なんか悩んでる感じだったじゃん。何考えてたの？」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_6,1.0]
　　　　　　　　　　[ChangeCaption,ケヴィン]
                    [PrintText,「その意外だなって顔やめてくれる？」,0.1]
                    [EndGroup]
...
　　　　　　　　　　[ChangeCaption,ルナ]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_7,1.0]
                    [ChangeCaption,ケヴィン]
                    [PrintText,「アンタのことはよくわかんないけど、話したくなったらでいいよ。ほら、あいつら結構面倒見いいやつ多いし…まぁでも…。」,0.1]
                    [EndGroup]

                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_8,1.0]
　　　　　　　　　　[ChangeCaption,ケヴィン]
                    [PrintText,「その顔はアンタには似合わないな…アンタの笑う顔が好きだよ。」,0.1]
                    [EndGroup]
                    ...
                    [BeginGroup]
                    [SoundVoice,unit6,VOICE12_ending6_9,1.0]
                    [ChangeCaption,ケヴィン]
                    [PrintText,「…あ、暗くなってきた。もう行こうか。多分アルがどっかに連れてってくれるだろうから。」,0.1]
                    [EndGroup]

　　　　　　　　　　[ChangeCaption,ルナ]
                    [PrintText,そう言うとケヴィンは私の手を引いて、街の中へと連れていく。,0.1]

                    [ChangeCaption,ルナ]
                    [PrintText,（しばらくは元の世界に戻れないかもしれないけれど、それでも、彼らと…ケヴィンと一緒にいられたらとても心強いな…。）,0.1]
